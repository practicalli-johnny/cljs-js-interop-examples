(defproject js-interop "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "js-interop.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main js-interop.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "js-interop.core/on-figwheel-reload"}

                :compiler {:main js-interop.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/js_interop.js"
